...
if [ "$selected_option" -eq 1 ]; then
    ...
    wget -O dnstt-server https://raw.githubusercontent.com/chiddy80/Lightweight-Script-Halo-Dnstt/new/main/dnstt-server
    chmod 755 dnstt-server    
    wget -O server.key https://raw.githubusercontent.com/chiddy80/Lightweight-Script-Halo-Dnstt/new/main/server.key
    wget -O server.pub https://raw.githubusercontent.com/chiddy80/Lightweight-Script-Halo-Dnstt/new/main/server.pub
